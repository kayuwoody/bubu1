  ...
  return (
    <header style={{
      ...
      <img src="assets/co-logo.png" alt="Coffee Oasis" style={{
        height: compact ? 32 : 40, width: "auto", objectFit: "contain", flexShrink: 0,
      }}/>
      ...
      <button onClick={togglePickup} style={{
        ...
        <span>{pickup === "car" ? "Curbside" : "Counter"}</span>
  ...
  return (
    <section style={{
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        }}>{hasReorder ? "Welcome back ✨" : "Coffee, sorted."}</div>
        <div style={{
          fontFamily: "'Nunito', system-ui", fontSize: compact ? 12 : 13,
          opacity: .92, marginTop: 2,
          whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis",
        }}>{hasReorder ? lastSummary : "Order ahead, skip the line."}</div>
      </div>
      {hasReorder && (
